...
import { to3_, from4_, trip_, toLocal3_, fromLocal4_ } from "../../recoil/state";
...
const ToSearch3 = () => {
  ...
  const [nextFrom, setNextFrom] = useRecoilState(from4_);
  const [nextFromLocal, setNextFromLocal] = useRecoilState(fromLocal4_);
