...
import { makeStyles, TextField, Container, Grid, useMediaQuery } from "@material-ui/core";
...
function DepartureDatePicker3() {
  const classes = style();
  //const [departureDate, setDepartureDate] = useState(new Date());
  const [departureDate, setDepartureDate] = useRecoilState(departureDate3_);
  const [departureDate4, setDepartureDate4] = useRecoilState(departureDate4_);
...
export default DepartureDatePicker3;
