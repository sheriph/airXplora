...
function DepartureDatePicker2() {
  const classes = style();
  //const [departureDate, setDepartureDate] = useState(new Date());
  const [departureDate, setDepartureDate] = useRecoilState(departureDate2_);
  const [departureDate3, setDepartureDate3] = useRecoilState(departureDate3_);
...
export default DepartureDatePicker2;
