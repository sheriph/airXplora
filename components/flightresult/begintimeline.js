...
import { Grid, Divider, Box, IconButton, Tooltip } from "@material-ui/core";
...
const BeginTimeline = ({ outBoundItinerary, flightOffer }) => {
  ...
  /* 
  console.log(
    "begin outboundItinerary flightOffer",
    outBoundItinerary,
    flightOffer
  ); */
    ...
    <TimelineItem>
      <TimelineOppositeContent classes={{ root: classes.oppositecontentroot }}>
        <Typography variant="body2" color="textSecondary">
          <img
            src={`/airlinelogo/${outBoundItinerary.segments[0].carrierCode}16.png`}
            width="16px"
            height="16px"
            alt="timelinelogo"
          />
      ...
      <TimelineContent classes={{ root: classes.timelinecontentroot }}>
        <Paper elevation={3} className={classes.paper}>
          ...
          <Typography variant="caption" component="p">
            Depart: {getTime(outBoundItinerary.segments[0].departure.at)},
            {getDate(outBoundItinerary.segments[0].departure.at)} |&nbsp;
            <GetAirlineName
              airlineCodes={outBoundItinerary.segments[0].carrierCode}
            />
            <Tooltip
              title={
                <Typography variant="caption" component="p">
                  ...
                  <GetAirlineName
                    airlineCodes={
                      outBoundItinerary.segments[0].operating
                        ? outBoundItinerary.segments[0].operating.carrierCode
                        : outBoundItinerary.segments[0].carrierCode
                    }
                  />
                  &nbsp;
                  {outBoundItinerary.segments[0].aircraft.code}
                </Typography>
              }
              arrow
              placement="top"
                  ...
                  <Typography variant="caption" component="p">
                    {
                      getBaggageAllowance(
                        flightOffer,
                        outBoundItinerary.segments[0].id
                      )[0]
                    }
                  </Typography>
                </Grid>
